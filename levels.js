...
export const LEVELS = [
  { id:1, stage:1, title:'たまご', short:'名前をつける', minutes:1,
  ...
  { id:2, stage:1, title:'子グモ', short:'餌をあげる', minutes:1,
  ...
  { id:3, stage:1, title:'3Dモデル', short:'どけてもらう', minutes:2,
  ...
  { id:4, stage:1, title:'実写写真', short:'写真を探す', minutes:2,
  ...
  { id:5, stage:1, title:'実写動画', short:'動く', minutes:2,
  ...
  { id:6, stage:1, title:'手の上', short:'モデリング', minutes:2,
  ...
  { id:7, stage:2, title:'AR 2.5m', short:'見つける', minutes:3,
  ...
  { id:8, stage:2, title:'AR 1.5m', short:'餌で誘導', minutes:3,
  ...
  { id:9, stage:2, title:'AR テーブル', short:'道を作る', minutes:3,
  ...
  { id:10, stage:2, title:'AR 手の上', short:'30秒', minutes:3,
  ...
  { id:11, stage:2, title:'AR 自由', short:'見ているだけ', minutes:3,
...
export const GUIDE_LINES = {
  ...
  unlockedByTime:'嫌さは下がらなくていい。逃げずに居られた、それで十分。次へ。',
  notyet:'今日はここまででOK。次に開いたとき、同じレベルを1分だけやろう。',
};
